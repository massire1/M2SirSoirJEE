...
<form:form autocomplete="off" action="/saveHabitationIndiv" method="post" modelAttribute="habitation">
	...
	<div class="form-group row align-items-center">
		...
		<div class="col-sm-1">
			<form:input path="nbrPiece" class="form-control" />
		</div>
		<div class="col-sm-offset-3 col-sm-9"><small class="form-text text-danger"><form:errors path="nbrPiece" /></small></div>
	</div>
	<div class="form-group row align-items-center">
